    ...
    $.get("http://localhost:5000/api/recipes/"+id, function(data)  {
        ...
        $(data).each(function(key, object) {
            ...
            for(n = 0; n < object['ingredients'].length; n++) {
                ingredient_string += object['ingredients'][n]+", ";
           }
           ...
           //ingredients
            ...
            //ingredients
            left_content_string += "<h5 class='mt-4 mb-2 ml-5 text-left' style='font-weight: bold'>Ingredients</h5><div class='text-left ml-5' style='min-height: 80px;'>"+ ingredient_string + "</div>";
            //image
